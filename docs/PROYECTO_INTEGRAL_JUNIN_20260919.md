...
Segunda ampliacion del 23/09: los [modulos 9 y 10](NOELIA_MODULOS_9_10_20260923.md) agregan recibos con firma/acceso individual y estructura anual de cargos. Se revisaron otra vez las 27 paginas de los modulos 1–7 y se actualizo la [matriz comun](MATRIZ_ACEPTACION_NOELIA.md). Recibos se integra con DOC-01 y fases C/D; presupuesto de cargos se integra con C y control presupuestario, conservando unidades y versiones. La rectificacion administrativa 104 no sustituye ese presupuesto.

Estado actualizado de fase A al 23/09, ventana 15:45 UTC: seis colectores locales operativos, incluido PM10 como un integrante del mismo parque. Oracle conserva runtime e instalacion y fue actualizado a los mismos 29 archivos del paquete vigente; seis plantillas preparadas y desactivadas. La autonomia cloud sigue pendiente por rechazo del certificado servidor VPN y por el traspaso controlado de configuracion/colas. No hay un segundo consumidor activo ni se debilito la validacion TLS. El cierre de A exige transferencia sin duplicacion, reinicio y captura/acuse con la PC apagada, tambien si el host elegido es Oracle.

El estado de septiembre y de los incrementos 101–104 se mantiene en el [estado integral actualizado](ESTADO_INTEGRAL_NOELIA_HUGO_MARIANO_20260921.md). Las afirmaciones posteriores de este documento sobre candidato inactivo y conectividad corresponden al corte historico del 19/09; no sustituyen esas comprobaciones posteriores.
