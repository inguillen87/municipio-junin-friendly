...
edit('internal-dashboard.html',s=>{if(s.includes('summaryDownload.dataset.payrollSummaryDownload'))return s;s=one(s,'        actions.append(payroll, novelty, calculate, request, absence);',`        const downloads = create('button', 'button', 'Descargar haberes por mes');
