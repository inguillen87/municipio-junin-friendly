...
export async function verifyLegalRegistryPublication(output){
 ...
 const files=['juridica-registro.html','internal-dashboard.html','assets/legal-registry-model.js','assets/legal-registry.css','assets/legal-registry-entry-card.css','assets/app-routes.js','assets/work-area-model.js',bundle.slice(1)];
