...
export async function verifyLegalRegistryPublication(output){
 ...
 const files=['juridica-registro.html','internal-dashboard.html','assets/legal-registry-model.js','assets/legal-registry.css','assets/document-reader.css','assets/document-ocr-worker.js','assets/vendor/ocr/tesseract.min.js','assets/vendor/ocr/worker.min.js','assets/vendor/ocr/lang/spa.traineddata.gz','assets/vendor/ocr/tesseract-core-lstm.wasm.js','assets/vendor/ocr/tesseract-core-simd-lstm.wasm.js','assets/vendor/ocr/tesseract-core-relaxedsimd-lstm.wasm.js','assets/legal-pdf-text-worker.js','assets/legal-pdf-text-model.js','assets/legal-registry-entry-card.css','assets/app-routes.js','assets/work-area-model.js',bundle.slice(1)];
