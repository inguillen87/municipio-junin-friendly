...
BEGIN
 ...
 INSERT INTO attendance_pm10_receipt(id,tenant_id,connector_id,device_id,batch_key,part_start,manifest_sha256,request_sha256,snapshot_sha256,captured_at,record_count,result) VALUES(receipt_id,c.tenant_id,c.id,d.id,p_body->>'batchId',part_n,mh,ph,p_body->>'snapshotSha256',captime,n,answer);
