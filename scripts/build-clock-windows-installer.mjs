...
export async function buildInstaller({kit,runtime,runtimeLicense,output,allowDirtyForTest=false}){
 ...
 const metadata={schema:'municontrol-windows-installer.v1',productVersion:'1.1.0',releaseCommit:RELEASE_COMMIT,installerCommit,sourceDirty:dirty,nodeVersion:NODE_VERSION,credentialsIncluded:false,municipalRecordsIncluded:false,activationDefault:'stopped',architecture:'x64',files};
 ...
 const strings={PayloadSha256:hash(zipped),ManifestSha256:hash(manifestBytes),ReleaseCommit:RELEASE_COMMIT,InstallerCommit:installerCommit,NodeSha256:NODE_SHA256,NodeVersion:NODE_VERSION,ProductVersion:'1.1.0'};
