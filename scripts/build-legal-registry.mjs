...
export async function buildLegalRegistry(root,output){
 ...
 for(const asset of ['internal-legal-followups.html','internal-legal-coordination.html','internal-legal-matters.html','assets/legal-followups-model.js','assets/legal-followup-review.js','assets/legal-followups-ui.js','assets/legal-followups.css','assets/legal-agenda-model.js','assets/legal-agenda-ui.js','assets/legal-coordination-model.js','assets/legal-coordination-ui.js','assets/legal-coordination.css','assets/legal-matters-model.js','assets/legal-matters-ui.js','assets/legal-matters.css'])await fs.copyFile(path.join(root,asset),path.join(output,asset));
