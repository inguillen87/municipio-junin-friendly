...
export async function buildLegalRegistry(root,output){
 ...
 for(const asset of ['internal-legal-followups.html','assets/legal-followups-model.js','assets/legal-followups-ui.js','assets/legal-followups.css','assets/legal-agenda-model.js','assets/legal-agenda-ui.js'])await fs.copyFile(path.join(root,asset),path.join(output,asset));
