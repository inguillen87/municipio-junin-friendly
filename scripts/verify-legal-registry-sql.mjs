...
assert.equal(url.hostname,'ep-silent-tooth-acpst3tx-pooler.sa-east-1.aws.neon.tech');assert.equal(url.pathname,'/neondb');
const client=new Client({connectionString:url.href});const schema='legal_069_qa_'+Date.now();let checks=0;
