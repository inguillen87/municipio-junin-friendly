...
try{
 ...
 await page.setViewportSize({width:390,height:844});assert.ok(await page.evaluate(()=>document.documentElement.scrollWidth<=innerWidth+1));await page.screenshot({path:out+'/mobile.png'});checks.push('390px viewport retains readable controls and has no horizontal overflow');
