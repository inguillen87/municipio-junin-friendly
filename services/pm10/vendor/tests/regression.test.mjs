...
import {collect,CHUNK_BYTES} from '../lector-fichadas.mjs';
import {withClock,fakeKey} from './fixture.mjs';
...
test('entrada/identificador de version presentes en paquete',async()=>{
 const code=await readFile(new URL('../lector-fichadas.mjs',import.meta.url),'utf8');assert.match(code,/4\.1\.0/);assert.match(code,/neutralSessionDataFrames/);
});
