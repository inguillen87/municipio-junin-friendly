...
function mapError(error) {
  ...
  if (/(CAPABILITY|AUTHORITY|SOD_CONFLICT)/.test(error?.message || '')) return new PayrollParameterError('PAYROLL_PARAMETER_CAPABILITY_REQUIRED', 403, 'La membresía no permite esta operación.');
