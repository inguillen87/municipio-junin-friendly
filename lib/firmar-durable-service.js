...
export function createFirmarDurableService({repository,env={},fetchImpl=fetch,now=()=>Date.now(),newId=randomUUID}={}){
 ...
 return Object.freeze({
  async begin({context,requestId,expectedVersion,signal}){
   ...
   if(source.requestId!==requestId||source.version!==expectedVersion)firmarPersistenceFail('FIRMAR_VERSION_CONFLICT');
