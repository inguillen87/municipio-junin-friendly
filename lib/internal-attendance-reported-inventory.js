...
import confirmedAdditions from '../data/junin-attendance-additions.v1.json' with {type:'json'};
import {appendReportedAdditions} from './attendance-inventory-additions.js';
...
const JUNIN_REPORTED_ATTENDANCE_INVENTORY = appendReportedAdditions(buildPayload(sourceInventory),confirmedAdditions,sourceInventory.source.sha256);
