...
const INTERNAL_DATA_RESOURCE_CAPABILITIES = Object.freeze({
  ...
  budgetpayrollcatalog: Object.freeze([C.WORKFORCE_STRUCTURE_READ,C.WORKFORCE_EMPLOYEE_READ,C.PAYROLL_READ]),
  budgetpayrollroster: Object.freeze([C.WORKFORCE_STRUCTURE_READ,C.WORKFORCE_EMPLOYEE_READ,C.PAYROLL_READ]),
  ...
  absenceperson: Object.freeze([C.ABSENCE_NOMINAL_READ]),
  ...
  payrolldocumentbatch: Object.freeze([C.WORKFORCE_EMPLOYEE_READ,C.PAYROLL_READ]),
  payrollexportroster: Object.freeze([C.WORKFORCE_EMPLOYEE_READ,C.PAYROLL_READ]),
  payrollsourcereport: Object.freeze([C.PAYROLL_READ]),
  employeepayrolldocuments: Object.freeze([C.WORKFORCE_EMPLOYEE_READ, C.PAYROLL_READ]),
  employeepayrolldetail: Object.freeze([C.WORKFORCE_EMPLOYEE_READ, C.PAYROLL_READ]),
  employeepayroll: Object.freeze([C.WORKFORCE_EMPLOYEE_READ, C.PAYROLL_READ]),
...
const ASSISTANT_INTENT_CAPABILITIES = Object.freeze({
  ...
  attendance_status: Object.freeze([C.ASSISTANT_USE, C.ATTENDANCE_READ]),
  ...
  out_of_scope: Object.freeze([C.ASSISTANT_USE]),
});
