...
- El registro de fuentes temporales 010A está implementado localmente; su apply/reapply PostgreSQL aislado sigue pendiente porque no se acreditó una rama Neon descartable para ese gate.
- El catálogo temporal 010B/011 está implementado localmente con calendarios, turnos diurnos/nocturnos, reglas tipadas, asignaciones, vigencia, maker-checker, idempotencia y solapamiento semanal cíclico. No fue aplicado a PostgreSQL ni habilita fichadas, cálculo o posting.
- La gobernanza global 012 permite solicitar/aprobar alta o baja de `PLATFORM_OWNER`, protege el último owner y deja el bootstrap excepcional del segundo owner fuera del runtime web. Está probada localmente, no instalada.
