(function (global) {
  ...
  var ROUTE_REQUIREMENTS = Object.freeze({
    ...
    'internal-legal-expedients.html': { any: ['legal.norm.read'] },
    'internal-legal-case-documents.html': { any: ['legal.norm.read'] },
    'internal-legal-case-actions.html': { any: ['legal.norm.read'] },
    'internal-legal-contracts.html': { any: ['legal.norm.read'] },
