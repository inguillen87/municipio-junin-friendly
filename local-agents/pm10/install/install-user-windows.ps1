...
foreach($file in @('service.mjs','sender.mjs','delivery.mjs','store.mjs','file-replacement.mjs','config.mjs','route-guard.mjs','delivery-status.mjs','check-host.mjs','host-readiness.mjs','user-supervisor.mjs','operation-status.mjs','package.json','LICENSE')){
