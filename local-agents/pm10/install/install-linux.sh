...
for f in service.mjs store.mjs config.mjs route-guard.mjs delivery-status.mjs check-host.mjs package.json LICENSE; do install -m 0644 "$source_dir/$f" /opt/municontrol-pm10/; done
